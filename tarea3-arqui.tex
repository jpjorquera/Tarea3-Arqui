...
Al ser $0$ el resto, el $beq$ dentro del loop lo dirige hacia el final, donde para facilitar la visualización se imprime el valor encontrado (que también queda en $s_0$) y se almacena en la salida creada al principio. 
