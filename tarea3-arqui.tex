...
A continuación, en el loop se guarda en variable auxiliar el termino s0 y se mueve s1 a s0 para finalmente mover el valor de t1 a s1 y realizar la suma de s2 con s1.
